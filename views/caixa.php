    ...
    <body class="w3-content" style="max-width:100%">
	        ...
	        <div class="w3-main" style="margin-left:270px">
	            ...
	            <header class="w3-container w3-deep-orange">
	              <h3 class="w3-left w3-deep-orange">Caixa</h3>
                  <p class="w3-right">
					...
					<a href="index.php" class="w3-bar-item w3-button w3-hover-black w3-deep-orange w3-border w3-border-black">Finalizar</a>    
