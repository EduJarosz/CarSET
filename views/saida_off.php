    ...
    <body class="w3-content" style="max-width:100%">
	        ...
	        <div class="w3-main" style="margin-left:270px">
	            ...
	            <header class="w3-container w3-deep-orange">
	                <h3 class="w3-left w3-deep-orange"> Saída </h3>
	                <p class="w3-right">
				...
				<div class="cadastro-new">
					...
					<form id="saida" method="POST" action="../controllers/saidaAvulsoController.php">
                    
                        <input type="hidden" name="vagaId" value="<?php echo $vagaId; ?>" />

					    <label>Data:</label>
						<input class="w3-input w3-border" type="date" name="datas">
						<label>Hora Saida:</label>
						<input class="w3-input w3-border" type="time" name="horas">
